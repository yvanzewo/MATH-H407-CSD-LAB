...
Ts = 1/fs; 
Tcycle = Ts;
lengthExp=65; %Set the length of the experiment (in seconds). 
...
kp_m = 4;
ki =1.834;%1.834 %0.496;
kp_r =1.31;%1.31 %0.251;
...
plot(time,real_position_cm(:),time,position_ref(:))
legend("Ring position(cm)","reference position(cm)")
xlabel("Time(s)")
